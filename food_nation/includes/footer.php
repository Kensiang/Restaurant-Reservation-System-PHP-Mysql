          ...
          <div class="container">
            ...
            <div class="col-md-4 mb-5">
              <div class="footer-widget">
                ...
                <p><a href="#section-contact" target="_blank" class="btn btn-primary btn-outline-primary">Contact Us</a></p>
              </div>
            </div>
            <div class="col-md-4 mb-5">
              <div class="footer-widget">
            ...
            <div class="col-md-4">
              <div class="footer-widget">
                ...
                <ul class="list-unstyled social">
                  <li><a href="https://www.tripadvisor.com/"><span class="fa fa-tripadvisor"></span></a></li>
