<?php
	...
	$mysqli = new mysqli('localhost', 'root',$password, 'food_nation');
	$id=$_GET['id'];
    ...
    if(isset($_POST["update"])) {
		...
		$sql="update `products` set name='$name',location='$location', cuisine='$cuisine', price='$price'where id=$id";
		$result=mysqli_query($conn,$sql);	
        if ($result){
			//echo"Updated Successfully";
			header("Location:admin-managerestaurants.php");
        ...
        <div class="row">
            <div class="offset-2 col-8 font-size-xl">
                <div class="bg-secondary text-light rounded  text-center p-3">
                    <h2 class="font-weight-bold">Update Restaurant Detail</h2>
                </div>
                <form action="" method="POST" class="my-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" name="txtLocation" id="txtLocation" >
                    </div>
					<div class="form-group">
                        <label for="txtCuisine">Cuisine:</label>
                        <input type="text" class="form-control" name="txtCuisine">
                    </div>
					<div class="form-group">
