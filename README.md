...
4. Extract the files in C:\xampp/htdocs. 
5. open link localhost:[your Apache port number]/phpmyadmin on browser. (You can found your port number on XAMPP control panel).  
